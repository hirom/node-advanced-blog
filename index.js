...
mongoose
	.connect(
		"mongodb+srv://hirom:1234abc@cluster0.ofbunws.mongodb.net/blogUserDatabase?retryWrites=true&w=majority"
	)
	.then(console.log("Success: Conncted to MongoDB"))
	.catch((error) => {
...
app.listen(port, () => {
	console.log(`lisetning at port ${port}`);
});
